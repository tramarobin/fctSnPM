function posthoc=fctPostHoc2dS(nEffects,indicesEffects,maps1d,dimensions,modalitiesAll,typeEffectsAll,eNames,multiPerm,Perm,anovaEffects,maximalPerm,doAllInteractions,alphaT,alphaAOV,sub)
