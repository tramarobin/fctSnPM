...
function []=displayAnovaOn(mapF,Fthreshold,anovaEffects,Fs,xlab,ylab,ylimits,dimensions,nx,ny,xlimits,colorMap,imageSize,imageFontSize,equalAxis,deleteAxis,statLimit)
